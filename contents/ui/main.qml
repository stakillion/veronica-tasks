...
PlasmoidItem {
    ...
    readonly property bool iconsOnly: Plasmoid.pluginName === "stakillion.veronica.tasks" || Plasmoid.pluginName === "org.kde.plasma.icontasks"
    ...
    readonly property alias pulseAudio: pulseAudio
    ...
    Layout.minimumWidth: {
        ...
        return vertical ? 0 : taskList.Layout.maximumWidth;
    }
    Layout.minimumHeight: {
        if (shouldShrinkToZero) {
            return Kirigami.Units.gridUnit; // For edit mode
        }
        return !vertical ? 0 : taskList.Layout.maximumHeight;
    }
    ...
    Item {
        ...
        QtObject {
            ...
            readonly property QtObject margins: QtObject {
                ...
                readonly property int bottom: 4
            }
        }
