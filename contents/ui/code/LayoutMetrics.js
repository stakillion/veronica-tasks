...
function horizontalMargins() {
    const isIconOnly = (tasks.plasmoid.pluginName === "stakillion.veronica.tasks" || tasks.plasmoid.pluginName === "org.kde.plasma.icontasks");
    const spacingAdjustment = isIconOnly ? tasks.plasmoid.configuration.iconSpacing : 1
