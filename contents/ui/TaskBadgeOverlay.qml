...
Item {
    ...
    readonly property bool shiftBadgeDown: (Plasmoid.pluginName === "stakillion.veronica.tasks" || Plasmoid.pluginName === "org.kde.plasma.icontasks") && task.audioStreamIcon !== null
